...
| doc   | Doc extracts and gneerate documentation for Go packages.                                                                                    |
| vet   | Vet ecamines Go source code and reports suspicicsous contstructs, such as Printf calls whose arguements do not align with the format string |
